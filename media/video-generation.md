...
* **MiniMax H3 Max**：MiniMax 与 [fal.ai](https://fal.ai/) 联合出品，基于 MiniMax H3 后训练的视频生成模型，专为高速视频生成而优化。输出 480P、768P 主流分辨率，生成速度比 MiniMax H3 更快。当前支持 T2V（文生视频）、I2V（图生视频），全能参考生成能力敬请期待。
